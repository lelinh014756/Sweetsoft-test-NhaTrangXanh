      ...
      <div className="pt-[44px] pb-[50px] bg-[#f3f3f3]">
        <div className="grid-content">
          ...
          <div className="card w-full border-none bg-transparent">
            <div className="lg:flex gap-x-[30px] flex-nowrap">
              <div className="col-lg-6 col-md-12 col-sm-12 p-0 h-[298px] overflow-hidden rounded-[10px] group sm:mb-[20px] lg:mb-0 mb-[12px] fade-in from-left">
                <img
